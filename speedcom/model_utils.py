...
class ModelUtils:
    ...
    def combine_columns(nd_arrays):
        """
        column combine multiple arrays
        Args:
        -----
        nd_arrays: list of array of same length
        return: 
        -----
        np.array
        """
    ...
    def get_y_category(y_actual,min_edge, bin_width):
        ...
        Y_category: np.array
        """
        assert y_actual.max() > min_edge, 'min_edge \
                has to be smaller than maximum y_actual'
